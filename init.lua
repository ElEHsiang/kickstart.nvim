...
vim.keymap.set('n', '<leader>w<left>', ':wincmd h<cr>', { desc = '[W]indow Left' })
vim.keymap.set('n', '<leader>w<down>', ':wincmd j<cr>', { desc = '[W]indow Down' })
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        -- Default disable format on save
        return nil
      end,
      formatters_by_ft = {
        lua = { 'stylua' },
